...
FIX_MARKER = '## 2026-09-08 14:18 — Technika: live DM timerów postaci używa aktywnego szablonu\n'
FIX_ENTRY = '''## 2026-09-08 14:18 — Technika: live DM timerów postaci używa aktywnego szablonu
...
fix_path = Path('docs/ai/FIX_LOG.md')
fix_text = fix_path.read_text(encoding='utf-8')
if FIX_MARKER not in fix_text:
    fix_text = fix_text.replace('# Wpisy\n', '# Wpisy\n\n' + FIX_ENTRY, 1)
    fix_path.write_text(fix_text, encoding='utf-8')

STATE_MARKER = '### Technika / timery postaci — 2026-09-08\n'
STATE_SECTION = '''### Technika / timery postaci — 2026-09-08
...
'''
state_path = Path('docs/ai/PROJECT_STATE.md')
state_text = state_path.read_text(encoding='utf-8')
if STATE_MARKER not in state_text:
    state_text = state_text.replace(
        '## Produkcja Zeabur — stan potwierdzony 2026-09-08\n',
        STATE_SECTION + '## Produkcja Zeabur — stan potwierdzony 2026-09-08\n',
        1,
    )
    state_path.write_text(state_text, encoding='utf-8')

HANDOFF_MARKER = '## Technika / timery postaci — PR #68\n'
HANDOFF_SECTION = '''## Technika / timery postaci — PR #68
...
'''
handoff_path = Path('docs/ai/CURSOR_TO_CHATGPT.md')
