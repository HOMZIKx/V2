...
function baseConfig(overrides: Partial<ActivityEnv> = {}): ActivityEnv {
  return {
    ...
    ACTIVITY_RABBITMQ_URL: undefined,
    ACTIVITY_MULTI_GUILD_ENABLED: false,
    ...
    ACTIVITY_IDENTITY_BASE_URL: undefined,
    ACTIVITY_IDENTITY_CHARACTER_ASSERTION_AUD: undefined,
    ACTIVITY_TO_IDENTITY_CLIENT_ID: 'v2.activity-service',
    ACTIVITY_TO_IDENTITY_PRIVATE_KEY_PEM: undefined,
    ACTIVITY_TO_IDENTITY_ACTIVE_KID: undefined,
