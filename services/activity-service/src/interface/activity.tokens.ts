...
export const CHARACTER_VERIFY_PORT = Symbol('CHARACTER_VERIFY_PORT');
export const ACTIVITY_CLOCK = Symbol('ACTIVITY_CLOCK');
export const ACTIVITY_USE_CASES = Symbol('ACTIVITY_USE_CASES');
export const ACTIVITY_ADMIN_USE_CASES = Symbol('ACTIVITY_ADMIN_USE_CASES');
...
export const DISCORD_CHANNEL_VALIDATION = Symbol('DISCORD_CHANNEL_VALIDATION');
export const DISCORD_GUILD_METADATA = Symbol('DISCORD_GUILD_METADATA');
