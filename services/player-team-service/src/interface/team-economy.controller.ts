...
const importItemsSchema = z.object({
  items: z.array(seedItemSchema).min(1).max(2500),
});
...
export class TeamEconomyController {
  ...
  public async catalogStatus(
    ...
    return this.economy.catalogStatus(await this.viewerId(headers), workspaceId);
  }
  ...
  public async updateItem(
    ...
    return this.economy.updateItem(await this.viewerId(headers), workspaceId, {
      itemId,
      ...this.parse(updateItemSchema, body),
    });
  }
  ...
  public async createDrop(
    ...
    return this.economy.createDrop(await this.viewerId(headers), {
      workspaceId,
  ...
  public async createExpense(
    ...
    return this.economy.createExpense(await this.viewerId(headers), {
      workspaceId,
