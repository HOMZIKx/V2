  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'services/authorization-service/src/main.ts',
        ...
        'services/authorization-service/src/interface/authorization-exception.filter.ts',
        ...
        // Exercised by infra integration tests (skipped in CI unit coverage runs).
        'services/authorization-service/src/infrastructure/persistence/authorization-repository.ts',
        'services/authorization-service/src/infrastructure/config/load-env-file.ts',
        'services/authorization-service/src/infrastructure/db/run-migrations.ts',
      ],
    },
  },
});
