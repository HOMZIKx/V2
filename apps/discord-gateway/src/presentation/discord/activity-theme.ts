 ...
 */
export const ACTIVITY_MODULE_ACCENT = 0xd48632;

/** Hub Container accent (#D48632). */
export const ACTIVITY_HUB_ACCENT = ACTIVITY_MODULE_ACCENT;

/** Public event post Container accent (same module token). */
export const ACTIVITY_EVENT_ACCENT = ACTIVITY_MODULE_ACCENT;
