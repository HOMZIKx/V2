  ...
  public constructor(private readonly deps: ActivityInteractionDeps) {
    ...
    this.identityClient =
      ...
      createIdentityHttpClientOrNull({
        ...
        DISCORD_TO_IDENTITY_CLIENT_ID: deps.config.DISCORD_TO_IDENTITY_CLIENT_ID,
        DISCORD_TO_IDENTITY_PRIVATE_KEY_PEM: deps.config.DISCORD_TO_IDENTITY_PRIVATE_KEY_PEM,
        DISCORD_TO_IDENTITY_ACTIVE_KID: deps.config.DISCORD_TO_IDENTITY_ACTIVE_KID,
        IDENTITY_ASSERTION_AUD: deps.config.IDENTITY_ASSERTION_AUD,
