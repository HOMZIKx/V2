# Projekt Hard — presentation equipment/item bonus changes

Source: https://projekt-hard.eu/presentation (English presentation; accessed 2026-09-04).

## Scope and transcription notes

This report transcribes the presentation's **Equipment Changes**, **High-Level Equipment**, **Changes to weapons above level 25**, and **Spirit Stones** sections. Item rows below preserve the presentation tooltip wording, including `+9`/stone enhancement and required level. The page's tooltip class suffix is visibly truncated for some images (`Warrio`, etc.); where the class is unambiguous from the item, it is normalized to Warrior/Ninja/Sura/Shaman.

## 1. Equipment Changes

The presentation says:

> Changes have been made to many equipment pieces and jewelry to give them new life and better adapt them to Project Hard. Some bonuses were changed and equip level requirements for certain items were standardized.
>
> This was done to prevent a single type of item from dominating, make more item types useful, and allow players to better tailor their equipment to the statistics required by their character classes.

### Earrings

Verbatim rules/change list:

- The equip level for earrings with stats: Wooden / Gold / Copper / Silver has been standardized to level 12.
- The equip level for earrings with stats: Jade / Ebonite / Pearl / White Gold has been standardized to level 33.
- The bonuses of level 33 earrings have been changed - each of these earrings will now grant a character stat and additional HP, as previously seen with Ebonite Earrings.
- The equip level for earrings with stats: Crystal / Amethyst / Blue Tears has been standardized to level 54.
- Strength was added to Amethyst Earrings instead of Vitality, resulting in three earring types for classes:
  - Amethyst - Strength
  - Blue Tears - Intelligence
  - Crystal - Dexterity
- All level 54 earrings received bonuses similar to Blue Tears and Amethyst Earrings, as well as HP from level 33 earrings, to make them more attractive compared to level 33 earrings.
...
- The equip level for necklaces with stats: Jade / Pearl / Ebonite / White Gold has been standardized to level 42.
- The equip level for Crystal / Amethyst / Blue Tears necklaces has been standardized to level 54.
- The bonus on the Crystal Necklace has been changed.
...
- The equip level for Ebonite / Pearl / White Gold bracelets has been standardized to level 42.
- The equip level for Crystal / Amethyst / Blue Tears bracelets has been standardized to level 54.
- Changed bonuses in Gold and Cristal Bracelets.
- The stamina bonus on the Wooden Bracelet was replaced with a skill duration extension bonus.
- The bonuses on Copper and Jade Bracelets were replaced: Copper Bracelet now adds % damage to MP, and Jade Bracelet adds % damage to HP.
- The bonuses on Pearl and Amethyst Bracelets were replaced: Pearl Bracelet now grants a chance for Piercing Hit, and Amethyst Bracelet grants a chance to Stun.
...
- The equip level for Leather Boots / Jade Boots / Bronze Boots / Gold Boots has been standardized to level 29.
- Changed bonuses for Bronze Boots, Jade Boots, Golden Boots, and Firebird Shoes.
- The base defense of level 29 boots was standardized to 3 points.
- The equip level for Ecstasy / Phoenix / Rain / Fire Bird boots was standardized to level 55.
- The casting speed bonus on Ecstasy Boots and arrow evasion on Rain Boots were strengthened.
- The base defense of level 55 boots was increased from 5 to 8 points.
- The base defense bonus of boots below level 29 was standardized to 1 point.
...
- Defense on level 41 helmets was increased by several points at +7/+8/+9 for all classes to better distinguish them from level 21 helmets.
- Level 60 helmets are not available as drops - the block chance bonus was added to level 41 helmets instead.
...
Presentation overview (verbatim):

> High-level equipment has been added to introduce endgame content. This equipment is designed for characters level 80+,and will fully realize its potential in the Grotto of Exiles.
>
> Our goal is to allow continued progression for those striving to reach the highest levels.These items will not affect early gameplay in any way. They are intended for characters who have firmly established themselves in endgame locations.Rare high-level items will serve as motivation and a goal for building the strongest possible character.

### Soul Crystal jewelry — level 85

The presentation says:

> Soul Crystal equipment features enhanced bonuses compared to level 54 jewelry and also strengthens you in battles against Setaou.
>
> Source:
> Necklace, Bracelet - Azrael Chest
> Earrings - Craft at Seon-Pyeong
> Required key upgrade for earrings: Blue Soul Cristal (Azrael Chest)
...
> Provides resistance to boss skill damage as well as class resistance. Its standard skill resistance bonus has been split for better controlover its impact in PvM and PvP.
>
> The Titan Shield will be an invaluable aid in battles against Setaou and in high-level PvP encounters.
>
...
> Level 80 helmets are an excellent choice for equipment in the Grotto of Exiles.
>
> Level 95 helmets are endgame equipment that significantly strengthen your character in both PvM and PvP. Despite the built-in Strong against humans bonus, it can be re-gained in them in bonuses 1-5.
>
> Source:
...
> The required equip level increases along with the upgrade level. Gloria Boots received a bonus change focused on PvP.
>
> Origin: Phoenix and Rain Boots Upgrade
...
> These are by far the most difficult and valuable items to obtain in the entire game, symbolizing determination and true mastery.Only a few will manage to acquire them.
>
> Source: Upgrade from level 70 Armor +9
...
> Level 70 weapons now require level 85 to equip. They can only be obtained from the Beran-Setaou Chest or Azrael Chest with a small drop chance.
>
> All weapons have a built-in Strong against Humans bonus that increases with the weapon`s upgrade level (up to 20% at +9). Their remaining stats have been balancedto match level 65 weapons used for PvP. Despite the built-in Strong against humans bonus, it can be re-gained in them in bonuses 1-5.
>
> They will become another goal for high-level players actively participating in PvP and battles across various areas of the game, as well as an alternative - superior - PvP weaponat higher levels.
...
Verbatim presentation text:

> All weapons above level 25 have been changed to include two additional bonuses: Attack Value PvM and Magic Attack Value PvM.
> This was done so that they can be used as alternatives to level 30 weapons while progressing towards level 75 weapons, which are best for PvM.The changes do not eliminate the ability to use level 30 weapons with high average damage - they will still perform very well if someone acquires such a weapon.
>
> The additional bonus scales with the levels of subsequent weapons, also taking into account their base attack values.
> You can view it on our server Wikipedia in the weapon list or by holding the SHIFT key while hovering over the weapon.
> Weapons do not have any hidden Average Damage or Skill Damage.
>
> Additionally, the attack speeds of individual weapons have been standardized. This means high attack speed weapons won`t dominate anymore, and you`ll be able to see the full variety of available weapons on the server.
>
> In short, this does not mean significantly higher damage than before - the values were adjusted so there is no forced need to use level 30 weapons with Average Damage.
>
> This is our own solution and works great because it separates the PvM aspect from the character`s PvP damage, which is maintained in a very similar format you know from the old days.

**Exact values exposed in this presentation section:** no numeric per-weapon PvM table is printed on the slide. The presentation explicitly directs players to the Server Wikipedia weapon list or to SHIFT-hover the weapon for each exact `Attack Value PvM` / `Magic Attack Value PvM` value. The documented rule is therefore: all weapons above level 25 gain both PvM bonuses; values scale by subsequent weapon level and base attack value; no hidden Average Damage or Skill Damage; attack speeds standardized.

## 4. Spirit Stones

Verbatim rule text:

- The maximum Spirit Stone level is +4. The chance of successfully adding a Spirit Stone to a slot is 35%.
- The Magic Spirit Stone bonus has been changed to % damage added to MP.
- The amount of HP obtainable from the Vitality Stone has been increased.
- Increased the defense points that can be obtained from the Defense Spirit Stone.
...
For completeness, the exact item-name pattern shown by the tooltips is:

- Stone of Penetration +0, +1, +2, +3, +4
- Stone of Deathblow +0, +1, +2, +3, +4
- Stone of Cooldown +0, +1, +2, +3, +4
- Stone of Warrior +0, +1, +2, +3, +4
- Stone of Ninja +0, +1, +2, +3, +4
- Stone of Sura +0, +1, +2, +3, +4
- Stone of Shaman +0, +1, +2, +3, +4
- Stone of Monster +0, +1, +2, +3, +4
- Stone of Evasion +0, +1, +2, +3, +4
- Stone of Ducking +0, +1, +2, +3, +4
- Stone of Magic +0, +1, +2, +3, +4
- Stone of Vitality +0, +1, +2, +3, +4
- Stone of Defense +0, +1, +2, +3, +4
- Stone of Haste +0, +1, +2, +3, +4

## Old → new changes explicitly stated by the presentation
...
- **66 distinct non-stone equipment/item variants** transcribed: 40 standard equipment rows, 26 high-level equipment rows.
- **70 distinct Spirit Stone enhancement variants** transcribed: 14 stone types × 5 levels (`+0` through `+4`).
- **136 distinct item variants total**, plus the complete named rule/change text for earrings, necklaces, bracelets, boots, helmets, high-level jewelry/shield/helmets/boots/armor/level-70 weapons, weapons-above-25 PvM behavior, and Spirit Stones.
- Enhancement coverage: all equipment rows are the displayed `+9` rows; Spirit Stones are all displayed `+0` to `+4` rows.

## Screenshot artifacts

Key-slide captures saved under `/workspace/ph-presentation-shots/`:

- `equipment-changes.png` — Equipment Changes slide.
- `high-level-equipment.png` — High-Level Equipment slide.
- `weapons-above-25.png` — Changes to weapons above level 25 slide.
- `presentation-1.webp`, `presentation-2.webp`, `presentation-3.webp` — presentation background/slide assets downloaded from the page.

A direct screenshot attempt for the Spirit Stones slide failed in the browser capture tool; the full Spirit Stones text and all 70 tooltip variants are transcribed above.
