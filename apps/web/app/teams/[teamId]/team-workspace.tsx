...
export function TeamWorkspace({
  ...
  initialSnapshot: TeamWorkspaceSnapshot;
  teamId: string;
}) {
    ...
    <AppShell activeSection="teams" viewerName={initialSnapshot.viewerName}>
      <main className="team-workspace" id="main-content">
        ...
        <nav aria-label="Sekcje zespołu" className="workspace-tabs">
          ...
          <a href={`/teams/${teamId}/members`}>Członkowie</a>
          <a href={`/teams/${teamId}/history`}>Historia</a>
        </nav>
          ...
          <div className="workspace-main-column">
            <section className="panel workspace-characters-panel" id="characters">
              <header className="panel-header">
                ...
                <a className="secondary-button" href={`/teams/${teamId}/characters/new`}>
                    ...
                    <article className="workspace-character-row" key={character.id}>
                      ...
                      <div className="workspace-character-copy">
                        ...
                        <div className="workspace-character-actions">
                          ...
                          <a href={`/teams/${teamId}/characters/${character.id}/edit`}>
                            Edytuj profil
                          </a>
                          <a href={`/teams/${teamId}/characters/${character.id}`}>
                            Karta EQ (podgląd)
                          </a>
                        </div>
                      </div>
        ...
        <div className="mock-notice">
          Akcje, timery, notatki i EQ — DEFERRED_MOCK_PREVIEW. Postacie i członkowie z API.
        </div>
      </main>
    </AppShell>
  );
