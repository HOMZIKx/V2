...
- **Date:** 2026-09-02
- **Decision:** D-050 (on `cursor/p4-1-activity-domain` / PR #19 numbering)
- **Also known as:** D-037 on frontend-track branches (`codex/d037-web-product-workflow`, PR #30 direction) — **do not confuse** with P4 Discord D-037 on this branch
...
### Phase 0 ÔÇö preserve and freeze
...
### Phase 1 ÔÇö technical and product inventory
...
### Phase 3 ÔÇö information architecture and flows
...
### Phase 4 ÔÇö interface foundations
...
### Phase 5 ÔÇö production application shell
...
### Phase 6 ÔÇö vertical slices, one at a time
...
### Phase 7 ÔÇö Cursor integration per approved slice
...
### Phase 8 ÔÇö end-to-end hardening
...
Proceed to **Phase 5 ÔÇö production application shell** and implement the accepted
