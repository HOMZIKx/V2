...
| D-031 | Pakiet planistyczny P2 Identity Foundation                            | PROPOSED | Granice Identity, multi-provider, sesje — ADR-0009…0011 Proposed; DEC-003…009; bez implementacji — [handoff](ai/P2_IDENTITY_FOUNDATION_HANDOFF.md) |

Szczegółowe decyzje architektoniczne będą rozwijane jako ADR-y w `docs/architecture/decisions/`.

## Rewizje otwarte (P2 planning — 2026-08-05)

| ID    | Temat                                     | Status rewizji             | Uwaga                                                                                                       |
| ----- | ----------------------------------------- | -------------------------- | ----------------------------------------------------------------------------------------------------------- |
| D-016 | Discord-only account                      | REOPENED for supersession  | Konflikt z briefem multi-provider — **DEC-003**; do decyzji obowiązuje pierwotne ACCEPTED / NON_NEGOTIABLES |
| D-019 | Better Auth                               | REOPENED for re-evaluation | Brak pakietu w lockfile; **DEC-004** przed Accepted ADR frameworku                                          |
| D-017 | Session revoke on Discord membership loss | REOPENED (scope)           | **DEC-006** przy użytkownikach bez Discord                                                                  |
| D-020 | Server sessions + internal context        | CONFIRM pending            | **DEC-008** / **DEC-009**; rekomendacja: utrzymać opaque cookie session                                     |

Cursor **nie** traktuje REOPENED jako licencji na implementację sprzeczną z `NON_NEGOTIABLES` przed decyzją właściciela.
