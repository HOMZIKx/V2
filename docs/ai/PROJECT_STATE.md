...
| CURRENT_HEAD / PR_HEAD | `09be1dd6996e31575c677847ed79545239967c36` (pre-security-audit tip) |
| PR                     | #19                                                                 |
...
| **FOUNDATION_ADVERSARIAL_SECURITY_AUDIT_SHA** | _(this commit)_                            | Org IDOR + gateway rate limits — CRITICAL/HIGH = 0                |
